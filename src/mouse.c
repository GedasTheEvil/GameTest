	...
	if (state == GLUT_UP )
	{
		...
		switch(button)
		{
			...
			case MMB:
				...
				printf("Anubis x:%f , z%f ... VX %f, VZ %f   \n",anb[0].pos[0].x, anb[0].pos[0].z,anb[0].Verts[0],anb[0].Verts[2]);
			break;
		...
		else if(display == MainMENU)
		{
			...
			if(x > (int)(resX*0.422) && x < (int)(resX*0.58) &&
			     y > (int)(resY*0.285) && y < (int)(resY*0.33)){display = LOADING;LoadAll();/*display = 1;*/}
			
			   
			if(x > (int)(resX*0.420) && x < (int)(resX*0.58) &&
			     y > (int)(resY*0.456) && y < (int)(resY*0.503))display = ConfMENU;
			
			if(x > (int)(resX*0.420) && x < (int)(resX*0.58) &&
			     y > (int)(resY*0.542) && y < (int)(resY*0.603))display = CreditMENU;
			
			if(x > (int)(resX*0.420) && x < (int)(resX*0.58) &&
			     y > (int)(resY*0.628) && y < (int)(resY*0.681))Exit(0);
		}
		else if(display == GameMENU)
		{
		     ...
		     if(x > (int)(resX*0.422) && x < (int)(resX*0.58) &&
			  ...
			  if(x > (int)(resX*0.420) && x < (int)(resX*0.58) &&
			       y > (int)(resY*0.628) && y < (int)(resY*0.681)){Exit(666);display = MainMENU;}
	        }
		else if(display == ConfMENU )
		{
			if(x > (int)(resX*0.22) && x < (int)(resX*0.26) &&
			   y > (int)(resY*0.445) && y < (int)(resY*0.498))texres = 1;
			   
			if(x > (int)(resX*0.22) && x < (int)(resX*0.26) &&
			   y > (int)(resY*0.385) && y < (int)(resY*0.434))texres = 0;
			   
			   
			if(x > (int)(resX*0.186) && x < (int)(resX*0.226) &&
			   y > (int)(resY*0.116) && y < (int)(resY*0.166))music = !music;
			   
			if(x > (int)(resX*0.186) && x < (int)(resX*0.226) &&
			   y > (int)(resY*0.216) && y < (int)(resY*0.266))sound = !sound;
			   
			if(x > (int)(resX*0.675) && x < (int)(resX*0.714) &&
			   y > (int)(resY*0.266) && y < (int)(resY*0.318))fs = !fs;
			   
			if(x > (int)(resX*0.613) && x < (int)(resX*0.771) &&
			   y > (int)(resY*0.916) && y < (int)(resY*0.966)){PutConf();system("./rr.sh");}
			   
			if(x > (int)(resX*0.788) && x < (int)(resX*0.946) &&
			     y > (int)(resY*0.916) && y < (int)(resY*0.966))display = MainMENU;
